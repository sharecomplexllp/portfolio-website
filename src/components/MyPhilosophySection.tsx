...
const philosophyPoints = [{
  ...
  description: 'With the right mindset, every challenge becomes a stepping stone'
}];
export function MyPhilosophySection() {
  return <section id="philosophy" className="py-20 bg-white">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-gray-700 leading-relaxed space-y-6 text-lg">
            <p>
              ...
              <strong>Chartered Market Technician (CMT)</strong> and earning the{' '}
              <strong>Certified Financial Technician (CFTe)</strong>{' '}
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            {philosophyPoints.map((point, index) => <div key={index} className="bg-gradient-to-br from-slate-50 to-white p-6 rounded-xl border-2 border-[#1B5E7E]/20 hover:border-[#4CAF50] transition-all group">
